...
This is the final **interview-expression layer** for MDEP: a way to turn the implemented project, offline evidence, Code Deep-Dive corpus, and practical exercises into a clear spoken explanation. It does not replace any of them.
