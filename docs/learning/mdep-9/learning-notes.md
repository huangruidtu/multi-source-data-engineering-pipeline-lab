...
- **Deduplication:** rank natural keys by source version, landing/extract timestamp, then hash. The winner is stable and all losers remain diagnosable. Without a deterministic tie-breaker, a retry can choose a different row.
