...
- **Validation debt:** static tests and local Parquet evidence validate code paths, not Airflow scheduler behavior, container networking, PostgreSQL connectivity, or cloud credentials. This Story remains in progress until the runtime checklist is executed and evidenced.
