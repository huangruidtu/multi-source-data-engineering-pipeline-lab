...
**Honesty:** “The topology and model tests are implemented; checkpoint and Iceberg sink behavior are runtime deferred and not runtime validated.” 中文：不要说 exactly-once 已验证。
